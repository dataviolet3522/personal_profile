...
const ReactPortfolio = () => {
  useEffect(() => {
    ...
    const divElement = document.getElementById("viz1693241459493");
  ...
  return (
    ...
    >
      <noscript>
        <a href="#">
          <img
            ...
            src="https://public.tableau.com/static/images/Ta/TableauPortfolio_16932266939300/ReactPortfolio/1_rss.png"
            style={{ border: "none" }}
          />
        </a>
      </noscript>
      <object className="tableauViz" style={{ display: "none" }}>
        ...
        <param
          name="name"
          value="TableauPortfolio_16932266939300/ReactPortfolio"
        />
        <param name="tabs" value="yes" />
        <param name="toolbar" value="yes" />
        <param
          name="static_image"
          value="https://public.tableau.com/static/images/Ta/TableauPortfolio_16932266939300/ReactPortfolio/1.png"
        />
