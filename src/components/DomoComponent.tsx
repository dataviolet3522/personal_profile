...
const DomoComponent = () => {
  useEffect(() => {
    ...
    const divElement = document.getElementById("domoId");
    ...
    >
      <noscript>
        <a href="#">
          <img
            alt=" "
            src="https://public.tableau.com/static/images/Ta/TableauPortfolio_16932266939300/DomoPortfolio/1_rss.png"
            style={{ border: "none" }}
          />
        </a>
      </noscript>
      <object className="tableauViz" style={{ display: "none" }}>
        ...
        <param
          name="name"
          value="TableauPortfolio_16932266939300/DomoPortfolio"
        />
        <param name="tabs" value="yes" />
        <param name="toolbar" value="yes" />
        <param
          name="static_image"
          value="https://public.tableau.com/static/images/Ta/TableauPortfolio_16932266939300/DomoPortfolio/1.png"
        />
