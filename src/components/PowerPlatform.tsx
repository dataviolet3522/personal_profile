...
const PowerPlatform = () => {
  useEffect(() => {
    ...
    const divElement = document.getElementById("viz1693241439601");
  ...
  return (
    ...
    >
      <noscript>
        <a href="#">
          <img
            ...
            src="https://public.tableau.com/static/images/Ta/TableauPortfolio_16932266939300/PowerPlatform/1_rss.png"
            style={{ border: "none" }}
          />
        </a>
      </noscript>
      <object className="tableauViz" style={{ display: "none" }}>
        ...
        <param
          name="name"
          value="TableauPortfolio_16932266939300/PowerPlatform"
        />
        <param name="tabs" value="yes" />
        <param name="toolbar" value="yes" />
        <param
          name="static_image"
          value="https://public.tableau.com/static/images/Ta/TableauPortfolio_16932266939300/PowerPlatform/1.png"
        />
